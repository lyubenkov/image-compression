...
plt.xticks([]),plt.yticks([])
#plt.imshow(filter_butterworth(100, 300, 3, 13), cmap = cm.Greys_r,interpolation='nearest')
#plt.imshow(filter_hyperbole(100, 300, 3), cmap = cm.Greys_r, interpolation='nearest')
#lt.imshow(filter_butterworth(32, 100, 3, 3), cmap = cm.Greys_r, interpolation='nearest')
#plt.imshow(dct(8), cmap = cm.Greys_r, interpolation='nearest')
#plt.imshow(filter_stripe(32, 200), cmap = cm.Greys_r, interpolation='nearest')
